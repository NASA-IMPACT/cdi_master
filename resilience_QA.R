#this script takes the unique geoplatform id's and matches them straigh from the community to the master list on github.
...
#creates a new vector where the id's are check for matches. a no match results in NA. 
